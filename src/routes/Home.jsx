...
import { HomeWrapper, Banner, Testimonials, NewsletterSection, ClientImage } from '../css/HomeWrapper';
    ...
    return (
        <HomeWrapper>
            ...
            <Testimonials>
                ...
                <div>
                    <blockquote>
                        <ClientImage src={Lucas} alt="Produto 1" />
                    ...
                    <blockquote>
                        <ClientImage src={Maria} alt="Produto 2" />
                    ...
                    <blockquote>
                        <ClientImage src={Joao} alt="Produto 3" />
